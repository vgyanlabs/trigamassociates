...
export default function BlogPage() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Engaging Introductions: Capturing Your Audience's Interest The initial impression your blog post makes is crucial, and that's where your introduction",
      image: "public/images/blog-2.jpg?height=600&width=800&text=Drawing+Readers+In",
      category: "content",
      date: "March 7, 2025",
      readTime: "5 min read",
      author: "admin",
    ...
    },
    {
      ...
      excerpt: "Engaging Introductions: Capturing Your Audience's Interest The initial impression your blog post makes is crucial, and that's where your introduction",
      image: "public/images/blog-3.jpg?height=600&width=800&text=First+Impression",
      category: "content",
      date: "March 7, 2025",
      readTime: "5 min read",
      author: "admin",
    ...
    },
    {
      ...
      image: "public/images/blog-4.jpg?height=600&width=800&text=Hello+World",
      category: "content",
